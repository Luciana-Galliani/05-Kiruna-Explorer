...
function App() {
  ...
  return (
    <div style={{ position: 'relative', height: '100vh', paddingTop: contentPadding }}>
      ...
      {/* Header */}
      <header className={`d-flex justify-content-between align-items-center p-3 w-100 ${headerClass}`} style={{ zIndex: 2, height: '60px' }}>
        <h1 className="m-0">
          <Link to="/" className={isHomePage ? "text-light text-decoration-none" : "text-dark text-decoration-none"}>
            Kiruna eXplorer
          </Link>
        </h1>
        <div>
